Attribute VB_Name = "TestDBSheetFilteringModule"
Public Sub TestDBSheetFiltering()
    Dim dbLastRow As Integer
    Const testDB As String = "TestDB"

    dbLastRow = GetDBLastRow(testDB)
    DeleteItems testDB, dbLastRow
    
    Trim testDB, dbLastRow
End Sub
